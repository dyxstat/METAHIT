...
# This script takes a candidate-bin quality table and chooses the best assembly.
...
if len(sys.argv) < 4:
    print("Usage: choose_best_bin.py <candidate_quality.tsv> <min_completion> <max_contamination> [contamination_penalty]")
    sys.exit(1)
