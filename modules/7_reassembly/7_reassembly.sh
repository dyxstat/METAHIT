...
if [ "$#" -lt 18 ]; then
    echo "Usage: $0 -p <METAHIT_PATH> --bin <BIN> --assembly <ASSEMBLY> --hic1 <HIC1> --hic2 <HIC2> --sg1 <SG1> --sg2 <SG2> --bam <BAM> --outdir <OUTDIR> -t <THREADS> -m <MEMORY> [--checkm2_db <CHECKM2_DB>]"
    exit 1
fi
...
# If CheckM2 DB is provided, append it
