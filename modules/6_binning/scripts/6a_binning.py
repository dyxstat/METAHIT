...
if __name__ == '__main__':
    ...
    try:
        ...
        if not (os.path.exists(checkm_ar_gene_table) and os.path.exists(checkm_bac_gene_table)):
            ...
            mv1Cmd = 'mv ' + os.path.join(output_dir, 'binning_methods', 'INITIAL_BIN', 'checkm_bac', 'marker_gene_table.tsv') + ' ' + checkm_bac_gene_table
            mv2Cmd = 'mv ' + os.path.join(output_dir, 'binning_methods', 'INITIAL_BIN', 'checkm_ar', 'marker_gene_table.tsv') + ' ' + checkm_ar_gene_table
            os.system(mv1Cmd)
            os.system(mv2Cmd)
